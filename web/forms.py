...
class SearchForm(FlaskForm):
    ...
    radio1 = RadioField(choices=[('artist','Artist'),('track','Track')])

    input2 = StringField("Artist or Track (optional)")
    radio2 = RadioField(choices=[('artist','Artist'),('track','Track')])

    # input3 = StringField("Artist or Track (optional)")
    # radio3 = RadioField(choices=[('artist','Artist'),('track','Track')])

    # input4 = StringField("Artist or Track (optional)")
    # radio4 = RadioField(choices=[('artist','Artist'),('track','Track')])

    # input5 = StringField("Artist or Track (optional)")
    # radio5 = RadioField(choices=[('artist','Artist'),('track','Track')])